...
public class BaseDaoImpl extends HibernateDaoSupport implements BaseDao {
    ...
    public void delete(Serializable serializable) {
    	...
    	try { 
    		...
    		Logging.error(BaseDaoImpl.class, "Error en el metodo delete " + e.toString());
    ...
    public Serializable save(Serializable serializable) {
    	...
    	try { 
    		...
    		Logging.error(BaseDaoImpl.class, "Error en el metodo save " + e.toString());
    		obj = null;
    		if (tx != null && tx.isActive()) {    			
    			tx.rollback();    			    			
    		}
    ...
    public Serializable merge(Serializable serializable) {
    	...
    	try { 
    		...
    		Logging.error(BaseDaoImpl.class, "Error en el metodo merge " + e.toString());
    		obj = null;
    		if (tx != null && tx.isActive()) {    			
    			tx.rollback();    			    			
    		}
    ...
    public void update(Serializable serializable) {
    	...
    	try { 
    		...
    		Logging.error(BaseDaoImpl.class, "Error en el metodo update " + e.toString());
    		if (tx != null && tx.isActive()) {    			
    			tx.rollback();    			    			
    		}
    		throw e;
	...
	public void saveOrUpdate(Serializable serializable) {
    	...
    	try { 
    		...
    		Logging.error(BaseDaoImpl.class, "Error en el metodo saveOrUpdate " + e.toString());
    		if (tx != null && tx.isActive()) {    			
    			tx.rollback();    			    			
    		}
    		throw e;
