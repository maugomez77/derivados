...
public class ItemLabelDemo1 extends ApplicationFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7926736811508438302L;
	...
	static class LabelGenerator extends AbstractCategoryItemLabelGenerator
		 ...
		 * 
		 */
		private static final long serialVersionUID = 5294979056200675978L;
		/** The threshold. */
	...
	private static JFreeChart createChart(CategoryDataset dataset) {
		// create the chart...
		JFreeChart chart = ChartFactory.createBarChart("Item Label Demo 1", // chart
																			// title
