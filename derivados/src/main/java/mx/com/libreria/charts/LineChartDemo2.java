package mx.com.libreria.charts;
/* -------------------
 * LineChartDemo2.java
 * -------------------
...
public class LineChartDemo2 extends ApplicationFrame {
	 ...
	 *            the frame title.
	 */
	public LineChartDemo2(String title, ContadorFrecuencias frec) {
		super(title);
		//XYDataset dataset = createDataset();
		XYDataset dataset = createDataset(frec);
	...
	private static XYDataset createDataset(ContadorFrecuencias frec) {
	...
	public static void main(String[] args) {
		LineChartDemo2 demo = new LineChartDemo2("Line Chart Demo 2", null);
		demo.pack();
