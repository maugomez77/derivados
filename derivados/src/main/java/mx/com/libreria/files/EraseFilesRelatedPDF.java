...
public class EraseFilesRelatedPDF {
    ...
    public void limpiezaArchivos(final String directoryName) {
        ...
        for (int i = 0; i < listFiles.length; i++) {
            ...
            Logging.debug(EraseFilesRelatedPDF.class, "Fecha del archivo: " 
                + Utilerias.getDate(date, "yyyy-MM-dd HH:mm:ss"));            
            Logging.debug(EraseFilesRelatedPDF.class, "Fecha consideración: " 
            ...
            if (date.compareTo(dateToday) < 0) {
                Logging.debug(EraseFilesRelatedPDF.class, "Erasing the file: " 
