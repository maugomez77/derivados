			...
			<div class="wrapper">
				...
				<% if(request.getParameter("sessionid") != null 
					  ...
					  && session.getAttribute("uname") != null){  %>
						  ...
						  <p><h2>Valuacion sobre Put usando Black and Scholes</h2></p>    					    	    													
      					 
      					<form action="<%out.println(request.getContextPath());%>/opciones/put.jsp?sessionid=<%= session.getId() %>" method="post">
		    			...
		    			<% if (request.getParameter("Calcular") != null) {  
		    			 	...
		    			 	if (!Utilerias.isNullOrUndefined(request.getParameter("formaPago"))  
		    			 		...
		    			 		String link = request.getContextPath() + "/servlet/ServletDemo2ChartGenerator?type=put";
